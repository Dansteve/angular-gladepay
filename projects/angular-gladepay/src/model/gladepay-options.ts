...
export interface GladepayOptions {
  /**
   * development status
   */
...
export interface PrivateGladepayOptions extends GladepayOptions {
  /**
...
export interface PrivateGladepayOptionsWithEmitters extends GladepayOptions {
  /**
   * A function to be called on successful card charge. User’s can always be redirected to a successful or
   * failed page supplied by the merchant here based on response
   */
